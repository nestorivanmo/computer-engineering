/*
	...
	No. Cuenta: 315618648
	Nombre: 315618648_PRACTICA2_GPO8
	Descripción: 7 cubos en pantalla con vista en perspectiva
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		model = rotate(model, radians(-11.0f), vec3(0, 1, 0));
		...
		model = rotate(model, radians(-8.0f), vec3(0, 1, 0));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
